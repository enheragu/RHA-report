...
\section{Gestión de la complejidad y mantenibilidad} \label{sec:SW:gestion_complejidad}
    ...
    \begin{figure}[H]
        ...
        \caption{Análisis del código del proyecto. \completarCon{Hay que actualizar tanto la gráfica como la estética}}
    ...
    \completarCon{añadir el quesito que representa los porcentajes}

    Las métricas que miden el número de ficheros así como de funciones en los mismos son menos significativas, aunque un menor número de funciones normalmente implique una menor complejidad dentro de ese fichero no se puede establecer un número de referencia. Con la complejidad ciclomática ocurre lo mismo \completarCon {comentar lo que ocurre en SW crítico?}, bastará con mantener un control continuado de la misma y llevar a cabo correcciones puntuales para evitar que crezca en distintas funciones. Se pede ver en la figura \completar los resultados finales dichas métricas del sofware.

    \completarCon{Añadir la imagen correspondiente a la situación final}
