...
\hypersetup{
    pdftitle={Enrique Heredia Aguado - TFG - 2017-2018},
    pdfsubject={TFG - 2017-2018},
    pdfauthor={Enrique Heredia Aguado},
...
\newcommand{\completarCon}[1]{ \textcolor{pRojo}{\small{\MakeUppercase{\textbf{COMPLETAR: #1}}}}}
...
\newcommand{\iconoImagen}[1]{\raisebox{-.5\height}{\includegraphics[width=0.27\textwidth]{figuras/Imagenes_Piezas/#1.PNG}}}
\newcommand{\pieceDescription}[1]{
	\vspace{0pt} {\begin{minipage}[t]{.40\linewidth}\vspace{0pt}#1\\ \end{minipage}}}
...
\newcommand{\inconExplanation}[2]{
	\begin{minipage}{0.10\textwidth}
		\includegraphics[width=\textwidth]{figuras/Icons/#1.png}
	\end{minipage}
...
\newcommand{\inconExplanationOne}[1]{
	\begin{minipage}{0.10\textwidth}
		\includegraphics[width=\textwidth]{figuras/Icons/#1.png}
	\end{minipage}
	}
...
% TODO: \glsaddall
 ...
 \include{capitulos/punto_partida}

 \include{capitulos/mecanica}

 \include{capitulos/electronica}

 \include{capitulos/cinematica}

 \include{capitulos/control}
