...
\newcommand{\iconoImagen}[1]{\raisebox{-.5\height}{\includegraphics[width=0.25\textwidth]{figuras/Imagenes_Piezas/#1.PNG}}}
\newcommand{\pieceDescription}[1]{
	\vspace{0pt} {\begin{minipage}[t]{.20\linewidth}\vspace{0pt}#1\\ \end{minipage}}}
