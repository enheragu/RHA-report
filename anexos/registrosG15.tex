	...
	velocidad = velocidad & inverso(0x0400)
		...
		\begin{itemize}
			...
			\end{equation}
			\item Torque aplicado: \completarCon{who knows?¿}
			\item Detectar movimiento: Este registro se pone a uno cuando el servo se está moviendo a un \completarCon{goal??} de posición y a cero una vez llega. En caso de controlar en modo rueda este byte permanece inalterable.
		\end{itemize}
\begin{table}[htbp]
