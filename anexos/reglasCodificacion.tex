...
\minititulo{Orden de inclusión de ficheros}
    ...
    \completarCon{Revisar el código!}
    \\ 
...
\minititulo{Variables Locales}
    ...
    Las variables se definirán preferiblemente en el ámbito más bajo \completarCon{¿se dice así?} en que se vayan a utilizar. Preferiblemente la inicialización de las mismas se hará junto a la declaración.
    \\ 
...
Para todos los objetos debe haber constructores por defecto sin parámetros de entrada. Aunque se pueden añadir constructores que inicialicen los diferentes parámetros será obligatorio generar métodos que los inicialicen una vez construido el objeto. Arduino, aún estando basado en el lenguaje \codigo{C++} no permite un uso completo de memoria dinámica. Es especialmente importante para declarar estos objetos como miembros de otros. \completarCon{no se si está muy claro :|}
\\ 
